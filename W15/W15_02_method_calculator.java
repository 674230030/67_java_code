...
public class W15_02_method_calculator {
    ...
    static int sudtract ( int a , int b){
        return a - b;
    }
    ...
    public static void main(String[] args) {
        ...
        // 2) Method สำหรับลบเลข
        System.out.println("ผลบวกของตัวเลข = " + sudtract ( a , b ));
       
        // 3) Method สำหรับคูณเลข
        System.out.println("ผลบวกของตัวเลข = " + multiply ( a , b ));
       

        // 4) Method สำหรับหารเลข
        System.out.println("ผลบวกของตัวเลข = " + devide ( a , b ));
