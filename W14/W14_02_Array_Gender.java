...
public class W14_02_Array_Gender{
    public static void main(String[] args) {
        ...
        for (int i = 0; i < name.length; i++) {
            if (name[i].startsWith("นาง")) {
                System.out.println(name[i] + "เป้นเพศหญิง");
                count++;
            }else{
                System.out.println(name[i] + "เป็นเพสชาย");
                count++;
            }
        }
        ...
        for (int i = 0; i < name.length; i++) {
            if (name[i].startsWith("นาง")) {
                System.out.println((i+1) + "." + name[i] + "เป้นเพศหญิง");
                countAll++;
            }else{
                System.out.println((i+1) +  "." + name[i] + "เป็นเพสชาย");
                countAll++;
                countMale++;
            }
        }
        ...
        System.out.println("จำนวนนักเรียนทั้งหมด = " + countMale + " คน");

        System.out.println("จำนวนนักเรียนทั้งหมด = " + (countAll - countMale) + " คน");
